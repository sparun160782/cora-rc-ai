# CORA — Complete Architecture (The Single Bible)
...
![Extensive High-Level Architecture Diagram](<architecture-diagrams/Extensive High-Level Architecture Diagram.png>)
...
![Component Diagram](architecture-diagrams/ComponentDiagram.png)
...
![Cloud Deployment Architecture Diagram (GCP + Kubernetes)](<architecture-diagrams/Cloud Deployment Architecture Diagram (GCP + Kubernetes).png>)
